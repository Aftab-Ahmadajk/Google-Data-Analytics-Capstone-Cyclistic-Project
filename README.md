...
![Sample Image](./Images/davy-1.jpg)
...
## Resources:
Please find the complete Notebook available in my GitHub repository for access and to check the detailed analysis with proper output details of the code. [Complete Notebook]([https://github.com/Aftab-Ahmadajk/Google-Data-Analytics-Capstone-Cyclistic-Project](https://github.com/Aftab-Ahmadajk/Google-Data-Analytics-Capstone-Cyclistic-Project/blob/main/cyclistic_portfolio_complete_notebook.ipynb))
